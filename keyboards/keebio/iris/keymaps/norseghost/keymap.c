...
#define LAYOUT_iris_base( \
  ...
  LAYOUT_wrapper( \
     ...
     KC_MUTE,  KC_ESC, KC_TAB,  TD(WM), TD(LOWER), TD(RAISE), TD(LOWER), TD(RAISE), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_AE, KC_BRID,  \
                                        KC_DEL,    SYM_BKSP,  KC_SPC,    KC_SPC,    SYM_ENT, KC_LSFT                                    \
  )
