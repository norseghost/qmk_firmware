...
#define _________________QWERTY_R3_________________        KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_RALT
...
#define _________________RAISE_L1__________________        RGB_TOG, RGB_VAI, RGB_HUI, RGB_SAI, RESET
#define _________________RAISE_L2__________________        RGB_MOD, RGB_VAD, RGB_HUD, RGB_SAD, KC_BRIU
#define _________________RAISE_L3__________________        _______, _______, _______, _______, KC_BRID
